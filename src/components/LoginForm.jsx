...
export default function LoginForm() {
    ...
    function getReadableError(firebaseError) {
        const map = {
            ...
            "auth/invalid-credential": "Invalid email or password. If you are new, click Register first.",
            "auth/invalid-login-credentials": "Invalid email or password. If you are new, click Register first.",
            ...
            <div className="login-card">
                ...
                <form  className="login-form" onSubmit={handleEmailAuth}>
                    ...
                    <button className="btn-link" onClick={() => {setIsRegistering(!isRegistering); setError("");}}  disabled={loading}> {
                        isRegistering ? "Already have an account? Sign in" : "Do not have an account? Register"
                    }</button>
